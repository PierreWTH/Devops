...
final class Version20240625123000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE score (id INT AUTO_INCREMENT NOT NULL, synthesis_id INT NOT NULL, question_id INT DEFAULT NULL, comment LONGTEXT DEFAULT NULL, grade SMALLINT NOT NULL, INDEX IDX_32993751EC91FE48 (synthesis_id), INDEX IDX_32993751BCB134CE (question_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE score ADD CONSTRAINT FK_32993751BCB134CE FOREIGN KEY (question_id) REFERENCES question (id)');
